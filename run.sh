...
# #Export the variable:
# echo "Set Conda Cache"
# if [ ! -d "$WORK/conda/envs" ]; then
#     mkdir $WORK/conda
#     mkdir $WORK/conda/{pkgs,envs}
...
# conda create --prefix $WORK/envs/myenv --file /home/environment.yml
...
JUPYTER_ARGS="--certfile=$(cat ${TAP_CERTFILE}) --config=${TAP_JUPYTER_CONFIG} --ServerApp.root_dir=${WORK}/env"
